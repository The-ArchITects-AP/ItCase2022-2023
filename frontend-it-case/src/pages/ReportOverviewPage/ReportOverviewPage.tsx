                ...
                <div className={styles.reportContainer}>
                  <Link to={`/report/detail/${data.nid}`} key={data.nid}>
                    <p className={styles.title}>
                      ...
                      {
                      <img
                      src={`https://api.apiflash.com/v1/urltoimage?access_key=ad6f7c37ed5d4f3d9f42d09dcbcd4365&wait_until=page_loaded&url=${data.field_iframe}&delay=10&width=500&height=300`}
                      alt=""
                      width="500"
                      height="300"
                    />
